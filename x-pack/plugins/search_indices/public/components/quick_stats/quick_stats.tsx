...
export const QuickStats: React.FC<QuickStatsProps> = ({ index, mappings, documents }) => {
  ...
  const docCount = documents?.results?._meta?.page?.total ?? 0;
      ...
      <EuiFlexGroup gutterSize="none">
        <EuiFlexItem>
          <QuickStat
            ...
            secondaryTitle={<EuiI18nNumber value={docCount} />}
            stats={[
              {
                title: i18n.translate('xpack.searchIndices.quickStats.documents.totalTitle', {
                  defaultMessage: 'Total',
                }),
                description: <EuiI18nNumber value={docCount} />,
              },
              {
